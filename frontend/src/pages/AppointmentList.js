...
const API_BASE = 'https://hospital-backend-app-d5hzfjfqfbakbdcu.southeastasia-01.azurewebsites.net';
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-10 px-4">
            <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-2xl p-6">
                ...
                {message && (
                    <div className={`mb-4 p-4 rounded-lg text-center font-medium ${message.includes('successfully') ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                        }`}>
                        {message}
                    </div>
                )}
