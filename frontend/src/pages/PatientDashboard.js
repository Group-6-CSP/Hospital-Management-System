    ...
    useEffect(() => {
        ...
        if (patientId) {
            axios.get(`${API_BASE}/api/patients/${patientId}`)
                ...
                .catch(err => {
                    console.error('Error fetching patient info:', err);
                    setMessage('Failed to load patient information');
                    setLoading(false);
                });
        } else {
            setLoading(false);
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-10 px-4">
            <div className="max-w-5xl mx-auto">
                ...
                {message && (
                    <div className="mb-6 p-4 rounded-lg text-red-700 bg-red-100">
                        {message}
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Link to="/patient/book-appointment">
                        <div className="bg-blue-50 hover:bg-blue-100 transition rounded-xl p-6 shadow-md cursor-pointer h-full">
                            <div className="text-4xl mb-4">📅</div>
                            <h3 className="text-xl font-semibold text-blue-700 mb-2">
                                Book Appointment
                            </h3>
                    ...
                    <Link to="/patient/my-appointments">
                        <div className="bg-green-50 hover:bg-green-100 transition rounded-xl p-6 shadow-md cursor-pointer h-full">
                            <div className="text-4xl mb-4">📋</div>
                            <h3 className="text-xl font-semibold text-green-700 mb-2">
                                My Appointments
                            </h3>
                    ...
                    <Link to="/patient/billing">
                        <div className="bg-purple-50 hover:bg-purple-100 transition rounded-xl p-6 shadow-md cursor-pointer h-full">
                            <div className="text-4xl mb-4">💰</div>
                            <h3 className="text-xl font-semibold text-purple-700 mb-2">
                                Bills & Payments
                            </h3>
                    ...
                    <Link to="/patient/profile">
                        <div className="bg-orange-50 hover:bg-orange-100 transition rounded-xl p-6 shadow-md cursor-pointer h-full">
                            <div className="text-4xl mb-4">👤</div>
